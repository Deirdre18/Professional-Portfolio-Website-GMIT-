...
// You can comment out lines 9 and 28 to make it work locally
...
xhr.onload = function() {                       // When readystate changes
  ...
  //if(xhr.status === 200) {                      // If server status was ok
    ...
    // BUILD UP STRING WITH NEW CONTENT (could also use DOM manipulation - see js/data-xml-alt.js from ajax lab 3 )
    var newContent = '';
